...
(defun color-theme-goldkiss ()
  "Theme by Andreas Kissavos. Made for readability and softness."
  (interactive)
  (color-theme-install
   '(color-theme-goldkiss
     ((foreground-color . "#102e4e")
     ...
     (default ((t (nil))))
     (scroll-bar ((t (:background "DarkSlategray" :foreground "lightgreen"))))
     (modeline-buffer-id ((t (:background "goldenrod" :foreground "black"))))
     (modeline ((t (:background "goldenrod" :foreground "black" :box (:line-width 1 :style released-button)))))
     (mode-line-inactive ((t (:background "goldenrod" :foreground "black" :box (:line-width 1 :style released-button)))))
     (menu ((t (:background "DarkSlateGrey" :foreground "gold"))))
     (tool-bar ((t (:background "DarkSlateGrey" :foreground "gold" :box (:line-width 1 :style released-button)))))
     (font-lock-builtin-face ((t (:foreground "gold"))))
     (font-lock-comment-face ((t (:foreground "#bbbbff"))))
     (font-lock-delimiter-face ((t (:foreground "gold"))))
     (font-lock-constant-face ((t (:bold t :foreground "#ffaa88"))))
     (font-lock-doc-string-face ((t (:foreground "#bbbbff"))))
     (font-lock-doc-face ((t (:foreground "#gold"))))
     (font-lock-reference-face ((t (:foreground "#gold"))))
...
(defun color-theme-kissavos ()
  "Theme by Andreas Kissavos. Made for readability and softness."
  (interactive)
  (color-theme-install
   '(color-theme-kissavos
...
;      (foreground-color . "#eeeeee")
      ...
      (cursor-color . "goldenrod"))
     (bold ((t (:bold t))))
     (bold-italic ((t (:italic t :bold t))))
     (default ((t (nil))))
     (scroll-bar ((t (:background "DimGray" :foreground "black"))))
     (modeline-buffer-id ((t (:background "DimGray" :foreground "black"))))
     (menu ((t (:background "DimGray" :foreground "navajo white"))))
     (modeline ((t (:background "DimGray" :foreground "black" :box (:line-width 1 :style released-button)))))
     (fringe ((t (:background "DimGray"))))
     (mode-line-inactive ((t (:background "DimGray" :foreground "black" :box (:line-width 1 :style released-button)))))
     (menu ((t (:background "DimGray" :foreground "goldenrod"))))
     (tool-bar ((t (:background "DimGray" :foreground "goldenrod" :box (:line-width 1 :style released-button)))))
     (font-lock-builtin-face ((t (:foreground "goldenrod"))))
     (font-lock-comment-face ((t (:foreground "navajo white"))))
     (font-lock-delimiter-face ((t (:foreground "goldenrod"))))
     (font-lock-constant-face ((t (:bold t :foreground "navajo white"))))
     (font-lock-doc-string-face ((t (:foreground "navajo white"))))
     (font-lock-doc-face ((t (:foreground "#goldenrod"))))
     (font-lock-reference-face ((t (:foreground "#goldenrod"))))
;     (font-lock-function-name-face ((t (:foreground "indianred"))))
     (font-lock-function-name-face ((t (:foreground "LightSalmon"))))
     (font-lock-keyword-face ((t (:foreground "goldenrod"))))
     (font-lock-preprocessor-face ((t (:foreground "goldenrod"))))
     (font-lock-string-face ((t (:foreground "navajo white"))))))) 
